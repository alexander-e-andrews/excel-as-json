...
(function() {
  ...
  var BOOLTEXT, BOOLVALS, _DEFAULT_OPTIONS, _validateOptions, assign, convert, convertValue, convertValueList, excel, fs, isArray, parseKeyName, path, processFile, processWorksheet, transpose, write,
    indexOf = [].indexOf;
  ...
  processWorksheet = function(data, dst, options = _DEFAULT_OPTIONS, callback = void 0) {
    var result;
